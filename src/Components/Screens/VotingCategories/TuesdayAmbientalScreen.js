...
const filmes = [
  ...
  "Balanceia",
  "Penedo, o caminho das águas",
  "O que nos resta do Chico",
  "Epigramas",
  "Custos",
  "Meninos Verdes"
];

export default class TuesdayAmbientalScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      movieSelected: "",
  ...
  setVotacao = () => {
    const vote = "true";
    AsyncStorage.setItem("ambientalDiaUm", vote);
  };
