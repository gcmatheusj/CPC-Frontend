...
export default class SaturdayBrasileiroScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      movieSelected: "",
      categoria: "Festival do Cinema Brasileiro",
      userName: "",
      token: "",
      password: "",
      isFetching: ""
  ...
  setVotacao = () => {
    const vote = "true";
    AsyncStorage.setItem("brasileiroDiaCinco", vote);
  };
  ...
  handleVote = () => {
    ...
    axios
      .post(
        ...
        {
          categoryMovie: this.state.categoria,
